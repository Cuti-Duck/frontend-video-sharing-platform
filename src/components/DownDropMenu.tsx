...
export function DownDropMenu({user, logout}: DownDropMenuProps){
        ...
        <div className="relative inline-block text-left" ref={menuRef}>
            ...
            {isOpen && (
                <div className="absolute left-0 mt-2 w-40 bg-[#2f2f2f] rounded-md shadow-lg z-10">
                    <Link onClick={() =>setOpen(false)} href={`/channel/${user.userId}`} className="block px-4 py-2 hover:bg-[#838383]">Trang chủ</Link>
