                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-gray-800 text-white px-4 py-3 rounded-lg focus:outline-none border-1 border-white focus:ring-2 focus:ring-red-500"
                                maxLength={100}
                            />
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-neutral-700 rounded-lg p-4">
                            ...
                            <ol className="text-neutral-300 text-sm space-y-1 list-decimal list-inside">
                                ...
                                <li>Click <span className="font-bold text-green-500">Start Streaming</span></li>
                            </ol>
                        </div>
